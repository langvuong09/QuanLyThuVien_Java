...
public class XuatPhieuNhapGUI extends javax.swing.JDialog {
    ...
    public XuatPhieuNhapGUI(String nxb, String nhanVien, ArrayList<CTPhieuNhap> listCTPhieuNhap) {
    ...
    private void btnXacNhanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXacNhanActionPerformed
        ...
        phieuNhapBUS.themPhieuNhap(nxb, String.valueOf(dangNhapGUI.maTaiKhoan()), tongTien);

        int maPN = phieuNhapBUS.getMaPhieuNhapMoiNhat();
        ...
        for (CTPhieuNhap ctpn : listCTPhieuNhap) {
            hd += "<tr>";
            hd += "<td style='text-align:center;'>" + ctpn.getMaSach() + "</td>";
            for (Sach s : dss) {
                if (s.getMaSach() == ctpn.getMaSach()) {
                    hd += "<td style='text-align:left;'>" + s.getTenSach() + "</td>";
                    break;
                }
            }
            hd += "<td style='text-align:center;'>" + ctpn.getGia() + "</td>";
