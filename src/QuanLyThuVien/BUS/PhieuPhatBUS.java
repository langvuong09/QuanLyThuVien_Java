...
public class PhieuPhatBUS {
    ...
    public boolean nhapPhieuPhatExcel(String maPT, String docGia, String nhanVien, String thanhTien){
        try{
    ...
    public boolean themPhieuPhat(String maPP, String maPT, String docGia, String nhanVien, String thanhTien){
        if(maPT.trim().equals("")){
    ...
    public boolean suaPhieuPhat(String maPP, String maPT, String docGia, String nhanVien, String lyDo, String thanhTien){
        if(maPP.trim().equals("")){
